...
<header class="header">
    ...
    <nav class="navbar">
        ...
        <a href="login.php" class="btn1">Sign In</a>
...
<section class="pricing" id="pricing">
    ...
    <div class="plan basic">
        <h3>basic plan</h3>
<div class="price"><span></span>2000<span>/mo</span></div>
       <div class="list">
    ...
    <div class="plan">
        <h3>premium plan</h3>
        <div class="price"><span></span>4000<span>/mo</span></div>
       <div class="list">
        <p> <i class="fas fa-check"></i> personal training </p>
        <p> <i class="fas fa-check"></i> cardio exercise </p>
        <p> <i class="fas fa-check"></i> weight lifting </p>
...
<div class="credit"> created by <span>mr. Krishna</span> | all rights reserved! </div>
